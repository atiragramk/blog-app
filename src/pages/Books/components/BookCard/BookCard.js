...
import { deleteModalOpen } from "../Modal/reducer/deleteModal";
import { updateModalOpen } from "../Modal/reducer/updateModal";
import {
  deleteModalSelector,
  updateModalSelector,
} from "../Modal/selectors/modal";
import { bookItemFetch } from "../../../SingleBook/thunk/bookItem";
  ...
  return (
    <StyledCard>
      <CardBody>
        ...
        <StyledButton onClick={() => handleDeleteOpen(id)} color="ligth">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
